...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("currency_code", sa.String(), nullable=False, server_default="RUB"),
    ...
    op.create_table(
        ...
        sa.UniqueConstraint("user_id", "name", "direction", name="uq_finance_categories_user_name_direction"),
        schema="public",
    )
    ...
    op.create_table(
        ...
        sa.UniqueConstraint("user_id", "category_id", "period", name="uq_finance_budgets_user_category_period"),
        schema="public",
    )
